...
PRODUCT_COPY_FILES += \
	...
	vendor/samsung/gtexswifi/proprietary/lib/libbt-vendor.so:system/vendor/lib/libbt-vendor.so

#gpu
PRODUCT_COPY_FILES += \
	vendor/samsung/gtexswifi/proprietary/lib/egl/libGLES_mali.so:system/lib/egl/libGLES_mali.so \
 ...
 # 	vendor/samsung/gtexswifi/proprietary/lib/hw/hwcomposer.sc8830.so:system/lib/hw/hwcomposer.sc8830.so \
...
PRODUCT_COPY_FILES += \
	...
	vendor/samsung/gtexswifi/proprietary/bin/wcnd_cli:system/bin/wcnd_cli \
...
# PRODUCT_COPY_FILES += \
# 	vendor/samsung/gtexswifi/proprietary/gps/gps_sprd.so:system/lib/hw/gps.default.so \
# 	vendor/samsung/gtexswifi/proprietary/gps/patchram/HARRIER_ASIC_PATCH_SPRD.bin:system/etc/HARRIER_ASIC_PATCH.bin \
# 	vendor/samsung/gtexswifi/proprietary/gps/config/gps.sprd.xml:system/etc/gnss_cfg.xml
